...
<body class="theme-blush">
                            ...
                            <li>
                                <div class="progress-container progress-primary">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        ...
                                        <li>
                                            <img src="<?php echo base_url() ?>assets/images/xs/avatar2.jpg"
                                                alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="<?php echo base_url() ?>assets/images/xs/avatar3.jpg"
                                                alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="<?php echo base_url() ?>assets/images/xs/avatar4.jpg"
                                                alt="Avatar">
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li>
                                <div class="progress-container">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        <li class="m-r-15"><small>Team</small></li>
                                        <li>
                                            <img src="<?php echo base_url() ?>assets/images/xs/avatar10.jpg"
                                                alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="<?php echo base_url() ?>assets/images/xs/avatar9.jpg"
                                                alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="<?php echo base_url() ?>assets/images/xs/avatar8.jpg"
                                                alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="<?php echo base_url() ?>assets/images/xs/avatar7.jpg"
                                                alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="<?php echo base_url() ?>assets/images/xs/avatar6.jpg"
                                                alt="Avatar">
                                        </li>
                                    </ul>
                                </div>
                            ...
                            <li>
                                <div class="progress-container progress-warning">
                                    ...
                                    <ul class="list-unstyled team-info">
                                        <li class="m-r-15"><small>Team</small></li>
                                        <li>
                                            <img src="<?php echo base_url() ?>assets/images/xs/avatar5.jpg"
                                                alt="Avatar">
                                        </li>
                                        <li>
                                            <img src="<?php echo base_url() ?>assets/images/xs/avatar2.jpg"
    ...
    <aside id="leftsidebar" class="sidebar">
        <div class="navbar-brand">
            ...
            <a href="<?= base_url('Admin') ?>"><img src="<?php echo base_url() ?>assets/images/logo.svg" width="25"
        ...
        <div class="menu">
            <ul class="list">
                <li>
                    <div class="user-info">
                        <a class="image" href="#"><img src="<?php echo base_url() ?>assets/images/user.png"
                                alt="User"></a>
                        <div class="detail">
                            <h4><?= $this->session->userdata('userlogin'); ?></h4>
                ...
                <li class="<?php if ($this->uri->segment(1) == "Tiket") {
                                echo "active";
                            } ?>"><a href="<?= base_url('Tiket') ?>"><i
                            class="zmdi zmdi-ticket-star"></i><span>Ticket</span></a>
                </li>

                <!-- <li> <a href="javascript:void(0);" class="menu-toggle"><i
                            class="zmdi zmdi-ticket-star"></i><span>Ticket</span></a>
                    <ul class="ml-menu">
                        <li><a href="<?= base_url('Tiket') ?>">Tiket Masuk</a></li>
                        <li><a href="#">Daftar Tindakan Petugas</a></li>
                    </ul>
                </li> -->
                ...
                <li class="<?php if ($this->uri->segment(1) == "Laporan") {
                            ...
                            class="zmdi zmdi-file-text"></i><span>Laporan</span></a>
                    <ul class="ml-menu">
                        <li class="<?php if ($this->uri->segment(2) == "request") {
                                        echo "active";
                                    } ?>"><a href="<?= base_url('Laporan/request') ?>">Monitor request helpdesk</a>
                        </li>
                        <li class="<?php if ($this->uri->segment(2) == "category") {
                                        echo "active";
                                    } ?>"><a href="<?= base_url('Laporan/category') ?>">Laporan category
                                kerusakkan/penanganan</a></li>
                        <li class="<?php if ($this->uri->segment(2) == "penyebab") {
                                        echo "active";
                                    } ?>"><a href="<?= base_url('Laporan/penyebab') ?>">Laporan category
                                penyebab kerusakan</a></li>
                        <li class="<?php if ($this->uri->segment(2) == "percategory") {
                                        echo "active";
                                    } ?>"><a href="<?= base_url('Laporan/percategory') ?>">Presentasi Kerusakan
                                berdasarkan category </a></li>
                        <li class="<?php if ($this->uri->segment(2) == "user") {
                                        echo "active";
                                    } ?>"><a href="<?= base_url('Laporan/user') ?>"> Presentasi kerusakan berdasarkan
                                Nama user</a></li>
                        <li class="<?php if ($this->uri->segment(2) == "petugas") {
                                        echo "active";
                                    } ?>"><a href="<?= base_url('Laporan/petugas') ?>">Presentasi Penanganan
                                berdasarkan Petugas</a></li>
                        <li class="<?php if ($this->uri->segment(2) == "masalah") {
                                        echo "active";
                                    } ?>"><a href="<?= base_url('Laporan/masalah') ?>">Library masalah dan solusi</a>
                        </li>
                    </ul>
                </li>
                ...
                <!-- <li class="<?php if ($this->uri->segment(1) == "Laporan") {
                                    echo "active";
                                } ?>"><a href="<?= base_url('Laporan') ?>"><i
                            class="zmdi zmdi-file-text"></i><span>Laporan</span></a>
                </li> -->

                <li class="<?php if ($this->uri->segment(1) == "Asset") {
                                echo "active";
                            } ?>"> <a href="javascript:void(0);" class="menu-toggle"><i
                            class="zmdi zmdi-folder"></i><span>Non Asset</span></a>
                    <ul class="ml-menu">
                        <li class="<?php if ($this->uri->segment(2) == "category") {
                                        echo "active";
                                    } ?>"><a href="<?= base_url('Asset/category') ?>">Category</a></li>
                        <li class="<?php if ($this->uri->segment(2) == "data") {
                                        echo "active";
                                    } ?>"><a href="<?= base_url('Asset/data') ?>">Data non Assets</a></li>
                    </ul>
                </li>
                ...
                <li class="<?php if ($this->uri->segment(1) == "Petugas") {
                                echo "active";
                            } ?>"><a href="<?= base_url('Petugas') ?>"><i
                            class="zmdi zmdi-accounts-alt"></i><span>Petugas</span></a>
                </li>
                <li class="<?php if ($this->uri->segment(1) == "User") {
                                echo "active";
                            } ?>"><a href="<?= base_url('User') ?>"><i
                            class="zmdi zmdi-account"></i><span>User</span></a></li>
                <li><a href="<?= base_url('Login/logout') ?>"><i class="zmdi zmdi-power"></i><span>Logout</span></a>
                </li>
                <!-- <li><a href="<?= base_url('Aset') ?>"><i class="zmdi zmdi-folder"></i><span>Aset</span></a></li> -->
    ...
    <script src="<?php echo base_url() ?>assets/plugins/light-gallery/js/lightgallery-all.min.js"></script>
    ...
    <script src="<?php echo base_url() ?>assets/plugins/chartjs/polar_area_chart.js"></script>
